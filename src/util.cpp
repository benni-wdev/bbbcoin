...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BBBCoin";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "bbbcoin.conf"));
...
std::string LicenseInfo()
{
    return "\n" +
		   ...
		   FormatParagraph(strprintf(_("Copyright (C) 2017-%i The BBBCoin Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
